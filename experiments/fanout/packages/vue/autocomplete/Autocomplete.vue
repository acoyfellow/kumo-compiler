...
<template>
  <main data-part="root" class="p-8">
    <ComboboxRoot :collection="collection" :open="open" :inputValue="inputValue" :allowCustomValue="true" inputBehavior="none" :positioning="{ placement: 'bottom-start', offset: { mainAxis: 4, crossAxis: 0 } }">
