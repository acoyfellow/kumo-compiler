...
export function Autocomplete(props: AutocompleteProps) {
  return <main data-part="root" class="p-8">
    <Combobox.Root collection={collection} open={props.state === 'open'} inputValue="" allowCustomValue inputBehavior="none" positioning={{ placement: "bottom-start", offset: { mainAxis: 4, crossAxis: 0 } }}>
      <Combobox.Control class={fieldClass}>
        ...
        <Combobox.Input class={inputClass} value="" />
      </Combobox.Control>
