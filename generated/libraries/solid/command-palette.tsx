...
export function CommandPalette(incoming: CommandPaletteProps): JSX.Element {
  ...
  return (<div data-kumo-compound={"command-palette"}><div data-kumo-part={"root"}>{props.root ?? undefined}</div><div data-kumo-part={"collection"}>{props.collection ?? undefined}</div></div>);
}
