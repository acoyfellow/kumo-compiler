...
export interface SkeletonLineProps extends Record<string, unknown> { children?: JSX.Element; fixture?: unknown; styles?: Record<string, string>; }
...
export function SkeletonLine(incoming: SkeletonLineProps): JSX.Element {
