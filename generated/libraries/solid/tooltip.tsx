...
export function Tooltip(incoming: TooltipProps): JSX.Element {
  ...
  return (<button class={"inline-flex items-center bg-transparent border-none shadow-none p-0 m-0 h-auto min-h-0 leading-[0] cursor-default"} type={"button"} data-base-ui-tooltip-trigger={""}>{props.children}</button>);
}
