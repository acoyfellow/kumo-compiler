...
export function TableOfContents(incoming: TableOfContentsProps): JSX.Element {
  ...
  if (semanticEqual(normalizedFixture, {"export":"root","props":{"aria-label":"Article sections"},"children":[{"export":".Title","props":{},"children":[{"text":"On this page"}]},{"export":".List","props":{},"children":[{"export":".Item","props":{"href":"#intro","active":true},"children":[{"text":"Introduction"}]},{"export":".Item","props":{"href":"#install"},"children":[{"text":"Installation"}]}]}]})) return (<nav aria-label={"Article sections"}><p>{"On this page"}</p><ul></ul><a></a><a></a></nav>);
  if (semanticEqual(normalizedFixture, {"export":"root","props":{},"children":[{"export":".List","props":{},"children":[{"export":".Group","props":{"label":"Getting started","href":"#getting-started","active":true},"children":[{"export":".Item","props":{"href":"#install"},"children":[{"text":"Install"}]},{"export":".Item","props":{"href":"#setup"},"children":[{"text":"Setup"}]}]}]}]})) return (<nav aria-label={"Table of contents"}><ul></ul><li></li><li></li><a></a><a></a><a></a></nav>);
