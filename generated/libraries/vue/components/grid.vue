...
<template>
  <template v-if="semanticEqual(props.semanticContent, &quot;Two&quot;) &amp;&amp; Object.prototype.hasOwnProperty.call(semanticValues, &quot;gap&quot;) &amp;&amp; semanticEqual(semanticValues.gap, &quot;none&quot;) &amp;&amp; Object.prototype.hasOwnProperty.call(semanticValues, &quot;variant&quot;) &amp;&amp; semanticEqual(semanticValues.variant, &quot;side-by-side&quot;)"><div class="grid-cols-2 gap-0">{{ renderContent() }}</div></template><template v-else-if="semanticEqual(props.semanticContent, &quot;Cells&quot;) &amp;&amp; Object.prototype.hasOwnProperty.call(semanticValues, &quot;variant&quot;) &amp;&amp; semanticEqual(semanticValues.variant, &quot;3up&quot;)"><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">{{ renderContent() }}</div></template><template v-else><div :class="['grid', props.variant === '2up' ? 'grid-cols-1 md:grid-cols-2' : props.variant === 'side-by-side' ? 'grid-cols-2' : props.variant === '2-1' ? 'grid-cols-1 md:grid-cols-[2fr_1fr]' : props.variant === '1-2' ? 'grid-cols-1 md:grid-cols-[1fr_2fr]' : props.variant === '1-3up' ? 'grid-cols-1 lg:grid-cols-3' : props.variant === '3up' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : props.variant === '4up' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4' : props.variant === '6up' ? 'grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6' : props.variant === '1-2-4up' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-4' : '', (props.gap ?? 'base') === 'none' ? 'gap-0' : (props.gap ?? 'base') === 'sm' ? 'gap-3' : (props.gap ?? 'base') === 'base' ? 'gap-2 md:gap-6 lg:gap-8' : (props.gap ?? 'base') === 'lg' ? 'gap-8' : 'gap-2 md:gap-6 lg:gap-8', (props as any).className]"><slot /></div></template>
</template>
