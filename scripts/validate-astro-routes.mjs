...
for(const disclosure of ['41 / 41','The complete native component catalog','Svelte','Vue','Solid','/library-gallery/vue/','/library-gallery/svelte/','/library-gallery/solid/','all 41 components','Omissions:</strong> none'])
