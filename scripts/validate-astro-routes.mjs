...
for(const disclosure of ['Contract to native package','Observe once.','Prove every target.','Svelte','Vue','Solid','Start building','Open examples','kumo-vue-0.0.1.tgz','kumo-svelte-0.0.1.tgz','kumo-solid-0.0.1.tgz'])
