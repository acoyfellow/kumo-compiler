...
export function inventorySummary(value){return Object.fromEntries(['exports','declarations','tokens','files'].map(field=>[field,{count:value[field].length,sha256:sha(stable(value[field]))}]))}
