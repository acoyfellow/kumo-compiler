...
import {ref} from 'vue';
const options=[];const value=ref("2026-06-19");const query=ref('');const open=ref(false);const message=ref('Ready');const page=ref(1);const range=['',''];const start=ref(range[0]);const end=ref(range[1]);
